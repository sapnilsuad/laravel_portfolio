...
<body>
  ...
  <!-- ======= Hero Section ======= -->
  <div id="hero" class="hero route bg-image" style="background-image: url(<?php echo e(asset('assets/img/hero-bg.jpg')); ?>)">  
  ...
  <main id="main">
    ...
    <!-- ======= Counter Section ======= -->
    <div class="section-counter paralax-mf bg-image" style="background-image: url(<?php echo e(asset('assets/img/counters-bg.jpg')); ?>)">
    ...
    <section id="work" class="portfolio-mf sect-pt4 route">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="work-box">
              <a href="<?php echo e(asset('assets/img/work-2.jpg')); ?>" data-gallery="portfolioGallery" class="portfolio-lightbox">
                <div class="work-img">
                  <img src="<?php echo e(asset('assets/img/work-2.jpg')); ?>" alt="" class="img-fluid">
                </div>
              </a>
              <div class="work-content">
                <div class="row">
          ...
          <div class="col-md-4">
            <div class="work-box">
              <a href="<?php echo e(asset('assets/img/work-3.jpg')); ?>" data-gallery="portfolioGallery" class="portfolio-lightbox">
                <div class="work-img">
                  <img src="<?php echo e(asset('assets/img/work-3.jpg')); ?>" alt="" class="img-fluid">
                </div>
              </a>
              <div class="work-content">
                <div class="row">
          ...
          <div class="col-md-4">
            <div class="work-box">
              <a href="<?php echo e(asset('assets/img/work-4.jpg')); ?>" data-gallery="portfolioGallery" class="portfolio-lightbox">
                <div class="work-img">
                  <img src="<?php echo e(asset('assets/img/work-4.jpg')); ?>" alt="" class="img-fluid">
                </div>
              </a>
              <div class="work-content">
                <div class="row">
          ...
          <div class="col-md-4">
            <div class="work-box">
              <a href="<?php echo e(asset('assets/img/work-5.jpg')); ?>" data-gallery="portfolioGallery" class="portfolio-lightbox">
                <div class="work-img">
                  <img src="<?php echo e(asset('assets/img/work-5.jpg')); ?>" alt="" class="img-fluid">
                </div>
              </a>
              <div class="work-content">
                <div class="row">
          ...
          <div class="col-md-4">
            <div class="work-box">
              <a href="<?php echo e(asset('assets/img/work-6.jpg')); ?>" data-gallery="portfolioGallery" class="portfolio-lightbox">
                <div class="work-img">
                  <img src="<?php echo e(asset('assets/img/work-6.jpg')); ?>" alt="" class="img-fluid">
                </div>
              </a>
              <div class="work-content">
                <div class="row">
...
</html><?php /**PATH D:\xampp\htdocs\portfolio\resources\views/home.blade.php ENDPATH**/ ?>